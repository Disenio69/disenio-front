...
export class Notification{
    ...
    mostrar(){
        ...
        notificationNode.classList.add("rounded-lg", "w-full", "h-[30px]", "mx-auto", "mb-4", "py-1", "text-center", "text-white", "shadow-xl", "font-medium", "text-base", "notification","break-words");
